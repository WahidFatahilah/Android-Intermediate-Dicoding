...
class LoginActivity : AppCompatActivity() {
    ...
    private fun playanimation() {
        ...
        AnimatorSet().apply {
            playSequentially(titleTextView, messageTextView, emailEditText,emailEditTextLayout,  emailTextView,passwordEditText,
                 passwordEditTextLayout, passwordTextView,loginButton)
            start()
        }
    }
